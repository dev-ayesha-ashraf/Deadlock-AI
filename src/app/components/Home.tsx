...
export default function PurposeHome() {
  ...
  return (
    <section className="px-8 relative flex flex-col items-center justify-center pb-20 bg-brand-light-yellow md:[background:linear-gradient(270deg,theme(colors.brand-yellow/80)_40%,theme(colors.brand-white)_40%)]">
      {/* Background overlay */}
        ...
        <div className="space-y-6">
          ...
          <div className="flex space-x-4">
            <button
              ...
              className="inline-block font-mulish px-6 py-3 md:px-[35px] md:py-[17px] text-brand-black rounded-lg text-xs md:text-[14px] font-semibold md:font-bold shadow hover:scale-95 transition-transform bg-brand-yellow"
            >
              About Us
            </button>
            <button
              onClick={() => handleScrollToSection("contact")}
              className="inline-block font-mulish px-6 py-3 md:px-[35px] md:py-[17px] text-brand-black rounded-lg text-xs md:text-[14px] font-semibold md:font-bold shadow border-2 border-brand-yellow hover:scale-95 transition-transform bg-brand-white"
            >
              Contact Us
            </button>
          </div>
