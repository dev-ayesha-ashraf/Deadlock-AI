    ...
    <footer className="bg-brand-black text-brand-white pt-10 font-mulish">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-gray-700 mt-10">
        ...
        <div className="flex flex-col text-center items-center">
          <h4 className="text-xl font-semibold text-brand-yellow mb-4">Quick Links</h4>
          <ul className="space-y-2">
            <li>
              <button
                onClick={() => handleScrollToSection("products")}
                className="hover:text-brand-yellow cursor-pointer"
              >
                Products
              </button>
            </li>
        ...
        <div className="flex flex-col text-center items-center">
          <h4 className="text-xl font-semibold text-brand-yellow mb-4">Documentation</h4>
          <ul className="space-y-2">
            <li><a href="/refund-policy" className="hover:text-brand-yellow">Refund Policy</a></li>
            <li><a href="/terms-conditions" className="hover:text-brand-yellow">Terms & Conditions</a></li>
            <li><a href="/privacy-policy" className="hover:text-brand-yellow">Privacy Policy</a></li>
            <li><a href="/faq" className="hover:text-brand-yellow">FAQ's</a></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between text-sm text-gray-400">
        <img
          src="/deadlockai-white.png"
          alt="Logo"
          width={120}
          height={60}
        />
        <p className="mt-4 md:mt-0">© Copyright – Deadlock AI 2025. All rights reserved.</p>
      </div>
    </footer>
  );
}