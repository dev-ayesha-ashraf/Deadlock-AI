  ...
  return (
    <nav className="w-full h-[80px] bg-white flex items-center justify-between px-8 sticky top-0 z-[100] shadow-md border-b border-gray-100">
      ...
      <ul className="hidden md:flex flex-1 justify-center space-x-10 text-lg font-medium text-brand-dark">
        <li>
          <Link href="/" className="text-brand-yellow hover:text-brand-yellow/80 transition-colors cursor-pointer">
            Home
          </Link>
        </li>
        <li>
      ...
      <button
        ...
        className="md:hidden p-2 rounded-lg text-brand-yellow hover:bg-brand-yellow/10 transition cursor-pointer"
      >
        <Menu size={28} />
      </button>
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between mb-12">
                ...
                <button
                  onClick={() => setOpen(false)}
                  className="p-2 text-brand-black bg-brand-yellow cursor-pointer rounded-md hover:bg-brand-yellow/80 transition"
                >
                  <X size={28} />
                </button>
              </div>
