          ...
          >
            <div>
              ...
              <input
                ...
                required
                className="mt-2 block w-full rounded-lg border border-gray-200 px-4 py-3 focus:ring-2 focus:ring-brand-yellow focus:border-brand-yellow shadow-sm"
              />
            </div>
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-brand-yellow text-brand-black py-3 px-6 rounded-lg font-semibold shadow-md hover:bg-brand-yellow/90 transition"
            >
              {loading ? "Sending..." : (
                <>
