...
const faqData: FAQItem[] = [
  {
    id: 1,
    question: "How Does Deadlock AI Work?",
    answer: "Deadlock AI uses state-of-the-art neural networks to create custom automation workflows for enterprises. We begin with a deep dive into your data, followed by model selection and rigorous fine-tuning to ensure our AI aligns perfectly with your business logic."
  },
  {
    id: 2,
    question: "Is Deadlock AI easy to integrate with?",
  ...
  {
    id: 3,
    question: "Which AI models does Deadlock AI support?",
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="space-y-8">
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold mb-3 text-[brand-yellow]">
              ...
              {faqData.map((faq) => (
                ...
                >
                  <button
                    ...
                    className="w-full flex justify-between items-center px-4 py-3 font-semibold text-gray-800 bg-white hover:bg-[brand-yellow]/5 focus:outline-none cursor-pointer"
                    aria-expanded={openId === faq.id}
                  >
                    <span className="text-left text-base">{faq.question}</span>
                    <span
                      className={`text-[brand-yellow] text-xl transition-transform duration-200 ${openId === faq.id ? "rotate-180" : ""
                        }`}
                    >
                      ▾
                    </span>
