...
const termsSections: TermsSection[] = [
    ...
    content: (
      <div className="space-y-3">
        <p className="text-gray-700 text-md leading-relaxed">
          Legal agreement between Deadlock AI and our users for advanced computational and AI services.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-white border border-gray-200 rounded p-3 hover:border-[brand-yellow]/50 transition-colors duration-200">
            <h4 className="font-semibold text-gray-800 mb-1 text-[brand-yellow] text-md">Content</h4>
            <p className="text-md text-gray-600">
          ...
          <div className="bg-white border border-gray-200 rounded p-3 hover:border-[brand-yellow]/50 transition-colors duration-200">
            <h4 className="font-semibold text-gray-800 mb-1 text-[brand-yellow] text-md">Intellectual Property</h4>
            <p className="text-md text-gray-600">
          ...
          <div className="bg-white border border-gray-200 rounded p-3 hover:border-[brand-yellow]/50 transition-colors duration-200">
            <h4 className="font-semibold text-gray-800 mb-1 text-[brand-yellow] text-md">Third-Party Services</h4>
            <p className="text-md text-gray-600">
          ...
          <div className="bg-white border border-gray-200 rounded p-3 hover:border-[brand-yellow]/50 transition-colors duration-200">
            <h4 className="font-semibold text-gray-800 mb-1 text-[brand-yellow] text-md">Services</h4>
            <p className="text-md text-gray-600">
          ...
          <div className="bg-white border border-gray-200 rounded p-3 hover:border-[brand-yellow]/50 transition-colors duration-200">
            <h4 className="font-semibold text-gray-800 mb-1 text-[brand-yellow] text-md">Digital Platform</h4>
            <p className="text-md text-gray-600">
          ...
          <div className="bg-white border border-gray-200 rounded p-3 hover:border-[brand-yellow]/50 transition-colors duration-200">
            <h4 className="font-semibold text-gray-800 mb-1 text-[brand-yellow] text-md">Privacy Policy</h4>
            <p className="text-md text-gray-600">
          ...
          <div className="bg-white border border-gray-200 rounded p-3 hover:border-[brand-yellow]/50 transition-colors duration-200">
            <h4 className="font-semibold text-gray-800 mb-1 text-[brand-yellow] text-md">Personal Data</h4>
            <p className="text-md text-gray-600">
          ...
          <div className="bg-white border border-gray-200 rounded p-3 hover:border-[brand-yellow]/50 transition-colors duration-200">
            <h4 className="font-semibold text-gray-800 mb-1 text-[brand-yellow] text-md">Terms</h4>
            <p className="text-md text-gray-600">
      ...
      <div className="space-y-4">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index} className="flex items-start text-md">
                  <svg className="w-4 h-4 text-[brand-yellow] mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="bg-gray-50 rounded p-4 text-md">
          ...
          <p className="text-gray-600 mb-3">
            The Company respects the intellectual property rights of others and adheres to a strict policy of responding to any allegations of copyright or other intellectual property infringements. Copyright owners who believe their work has been infringed upon through the Service may submit a written notice to Us via email on contact@deadlockai.com or through our Customer Contact Form.
          </p>
          <p className="text-gray-600 mb-3">
  ...
  },
  {
    ...
    content: (
      <div className="bg-blue-50 border-l-3 border-[brand-yellow] p-4 rounded-r">
        <div className="flex items-center mb-2">
          <svg className="w-5 h-5 text-[brand-yellow] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/privacy-policy" className="inline-block mt-2 text-[brand-yellow] hover:underline text-md font-medium">
          Read Privacy Policy →
        </a>
      </div>
    ),
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto text-md">
                Rules and guidelines for interacting with Deadlock AI's intelligent platforms.
              </p>
            </div>
          </div>
        </div>
          ...
          {termsSections.map((section, index) => (
            ...
            >
              <div className="flex items-start gap-3 mb-4">
                <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-gradient-to-br from-[brand-yellow] to-[#2d8bc8] flex items-center justify-center">
