...
const privacySections: PolicySection[] = [
  {
    ...
    content: (
      <p className="text-gray-700 text-md leading-relaxed">
        This Privacy Policy ("Policy") describes how Deadlock AI (Private) Limited ("Company") collects, uses, and protects your data while training our AI models and delivering our services. We are dedicated to maintaining the highest privacy standards in line with global regulations.
      </p>
    ),
  },
  {
      ...
      <div className="space-y-4">
        <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 mb-3">
          <div className="flex items-center mb-2">
            <div className="w-6 h-6 rounded-full bg-[brand-yellow] flex items-center justify-center mr-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            ...
            <div key={index} className="bg-white border border-gray-200 rounded-lg p-3 hover:border-[brand-yellow] transition-colors duration-200">
        ...
        <div className="bg-gray-50 border-l-3 border-gray-300 p-3 rounded-r">
          <div className="flex items-start">
            <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[brand-yellow]/20 flex items-center justify-center mr-2 mt-0.5">
              <span className="text-sm font-semibold text-[brand-yellow]">3P</span>
            </div>
            <div>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div className="bg-gradient-to-r from-[brand-yellow]/5 to-white border border-[brand-yellow]/20 rounded-lg p-4 mb-3">
          <p className="text-gray-700 text-md leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
          <div className="bg-blue-50 border-l-3 border-[brand-yellow] p-4 rounded-r hover:shadow-sm transition-shadow duration-200">
            <div className="flex items-center mb-2">
              <div className="w-6 h-6 rounded-full bg-[brand-yellow]/20 flex items-center justify-center mr-2">
                <svg className="w-3 h-3 text-[brand-yellow]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="bg-gray-50 p-3 rounded text-md">
          ...
          <ul className="space-y-1 text-gray-700 ml-4">
            <li className="flex items-start">
              ...
              <span>contact@deadlockai – Send your withdrawal request via email for prompt processing.</span>
            </li>
            <li className="flex items-start">
              <span className="font-semibold mr-2">Postal Address:</span>
              <span>1303, Al Najeebi Electronic Market, Abdullah Haroon Road, Saddar, Karachi, Pakistan</span>
            </li>
          </ul>
        </div>
    ...
    content: (
      <div className="space-y-3">
        ...
        <div className="bg-blue-50 p-3 rounded text-md">
          <p className="text-gray-700 mb-1"><span className="font-semibold">Email:</span> contact@deadlockai.com</p>
      ...
      <section className="py-4 pb-2">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center px-3 py-1 bg-[brand-yellow]/10 text-[brand-yellow] rounded-full text-sm font-medium mb-3">
          ...
          {privacySections.map((section, index) => (
            ...
            >
              <div className="flex items-start gap-3 mb-3">
                <div className="flex-shrink-0 w-7 h-7 rounded-lg bg-gradient-to-br from-[brand-yellow] to-[#2d8bc8] flex items-center justify-center">
