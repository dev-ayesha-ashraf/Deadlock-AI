...
const policySections: RefundPolicySection[] = [
  {
    ...
    content: (
      <p className="text-gray-700 text-md leading-relaxed">
        Deadlock AI (Private) Limited ("Company") is committed to providing reliable and high-performance AI solutions. While we strive for complete satisfaction, the nature of cloud-based AI services means that payments are generally non-refundable unless specified in your individual Service Agreement. We do, however, evaluate refund requests based on the specific criteria detailed below.
      </p>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-3">
        <div className="flex items-start">
          <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[brand-yellow]/20 flex items-center justify-center mr-2 mt-0.5">
            <span className="text-sm font-semibold text-[brand-yellow]">1</span>
          </span>
          <p className="text-gray-700 text-md leading-relaxed">
        ...
        <div className="flex items-start">
          <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[brand-yellow]/20 flex items-center justify-center mr-2 mt-0.5">
            <span className="text-sm font-semibold text-[brand-yellow]">2</span>
          </span>
          <p className="text-gray-700 text-md leading-relaxed">
        ...
        <div className="flex items-start">
          <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[brand-yellow]/20 flex items-center justify-center mr-2 mt-0.5">
            <span className="text-sm font-semibold text-[brand-yellow]">3</span>
          </span>
          <p className="text-gray-700 text-md leading-relaxed">
  ...
  },
  {
    ...
    content: (
      <div className="bg-gradient-to-r from-[brand-yellow]/5 to-white p-4 rounded border border-[brand-yellow]/20">
        <p className="text-gray-700 text-md leading-relaxed mb-3">
          ...
          <a
            ...
            className="font-semibold text-[brand-yellow] hover:text-[#2d8bc8] hover:underline transition-colors duration-200"
          >
        ...
        <div className="flex items-center text-sm text-gray-600">
          <svg className="w-4 h-4 mr-2 text-[brand-yellow]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    title: "CONTACT US",
    content: (
      <div className="bg-gradient-to-r from-[brand-yellow]/10 to-[brand-yellow]/5 p-4 rounded border border-[brand-yellow]/30">
        <p className="text-gray-700 text-md leading-relaxed mb-4">
          For any queries related to refunds, or if you need assistance with the refund process, please contact us through{" "}
          <a
            href="contact@deadlockai.com"
            className="font-semibold text-[brand-yellow] hover:text-[#2d8bc8] hover:underline transition-colors duration-200"
          >
            contact@deadlockai.com
          </a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="flex items-center p-2 bg-white rounded border border-gray-200">
            <svg className="w-4 h-4 text-[brand-yellow] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
            </svg>
            <div>
              <p className="font-semibold text-gray-800 text-sm">Email Support</p>
              <p className="text-sm text-gray-600">contact@deadlockai.com</p>
            </div>
          </div>
          <div className="flex items-center p-2 bg-white rounded border border-gray-200">
            <svg className="w-4 h-4 text-[brand-yellow] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                policySections.map((section) => (
                  <div key={section.id} className="rounded-lg overflow-hidden border border-gray-200">
                    ...
                    >
                      ...
                      <span className={`text-[brand-yellow] text-xl transition-transform duration-300 ${activeSection === section.id ? 'rotate-180' : ''}`}>
                        ▾
                      </span>
                    </button>
